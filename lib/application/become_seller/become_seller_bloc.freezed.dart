...
mixin _$BecomeSellerEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is BecomeSellerEvent);
  }
...
class $BecomeSellerEventCopyWith<$Res> {
  $BecomeSellerEventCopyWith(
      BecomeSellerEvent _, $Res Function(BecomeSellerEvent) __);
}
...
class UpdateLogoPath implements BecomeSellerEvent {
  ...
  $UpdateLogoPathCopyWith<UpdateLogoPath> get copyWith =>
      _$UpdateLogoPathCopyWithImpl<UpdateLogoPath>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdateLogoPath &&
...
/// @nodoc
abstract mixin class $UpdateLogoPathCopyWith<$Res>
    implements $BecomeSellerEventCopyWith<$Res> {
  factory $UpdateLogoPathCopyWith(
          UpdateLogoPath value, $Res Function(UpdateLogoPath) _then) =
      _$UpdateLogoPathCopyWithImpl;
  @useResult
...
class UpdateFilePath implements BecomeSellerEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UpdateFilePathCopyWith<UpdateFilePath> get copyWith =>
      _$UpdateFilePathCopyWithImpl<UpdateFilePath>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdateFilePath &&
...
/// @nodoc
abstract mixin class $UpdateFilePathCopyWith<$Res>
    implements $BecomeSellerEventCopyWith<$Res> {
  factory $UpdateFilePathCopyWith(
          UpdateFilePath value, $Res Function(UpdateFilePath) _then) =
      _$UpdateFilePathCopyWithImpl;
  @useResult
...
class RemoveFilePath implements BecomeSellerEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RemoveFilePathCopyWith<RemoveFilePath> get copyWith =>
      _$RemoveFilePathCopyWithImpl<RemoveFilePath>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RemoveFilePath &&
            (identical(other.file, file) || other.file == file));
  }
...
/// @nodoc
abstract mixin class $RemoveFilePathCopyWith<$Res>
    implements $BecomeSellerEventCopyWith<$Res> {
  factory $RemoveFilePathCopyWith(
          RemoveFilePath value, $Res Function(RemoveFilePath) _then) =
      _$RemoveFilePathCopyWithImpl;
  @useResult
  $Res call({String? file});
}
...
class UpdateBgPath implements BecomeSellerEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $UpdateBgPathCopyWith<UpdateBgPath> get copyWith =>
      _$UpdateBgPathCopyWithImpl<UpdateBgPath>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is UpdateBgPath &&
            (identical(other.imagePath, imagePath) ||
                other.imagePath == imagePath));
  }
...
/// @nodoc
abstract mixin class $UpdateBgPathCopyWith<$Res>
    implements $BecomeSellerEventCopyWith<$Res> {
  factory $UpdateBgPathCopyWith(
          UpdateBgPath value, $Res Function(UpdateBgPath) _then) =
      _$UpdateBgPathCopyWithImpl;
  @useResult
  $Res call({String? imagePath});
}

/// @nodoc
class _$UpdateBgPathCopyWithImpl<$Res> implements $UpdateBgPathCopyWith<$Res> {
...
class SetDeliveryTimeType implements BecomeSellerEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SetDeliveryTimeTypeCopyWith<SetDeliveryTimeType> get copyWith =>
      _$SetDeliveryTimeTypeCopyWithImpl<SetDeliveryTimeType>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SetDeliveryTimeType &&
...
/// @nodoc
abstract mixin class $SetDeliveryTimeTypeCopyWith<$Res>
    implements $BecomeSellerEventCopyWith<$Res> {
  factory $SetDeliveryTimeTypeCopyWith(
          SetDeliveryTimeType value, $Res Function(SetDeliveryTimeType) _then) =
      _$SetDeliveryTimeTypeCopyWithImpl;
  @useResult
...
class SetDeliveryType implements BecomeSellerEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SetDeliveryTypeCopyWith<SetDeliveryType> get copyWith =>
      _$SetDeliveryTypeCopyWithImpl<SetDeliveryType>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SetDeliveryType &&
            (identical(other.type, type) || other.type == type));
  }
...
/// @nodoc
abstract mixin class $SetDeliveryTypeCopyWith<$Res>
    implements $BecomeSellerEventCopyWith<$Res> {
  factory $SetDeliveryTypeCopyWith(
          SetDeliveryType value, $Res Function(SetDeliveryType) _then) =
      _$SetDeliveryTypeCopyWithImpl;
  @useResult
  $Res call({String? type});
}
...
class CreateShop implements BecomeSellerEvent {
  const CreateShop({required this.context, required this.request});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CreateShopCopyWith<CreateShop> get copyWith =>
      _$CreateShopCopyWithImpl<CreateShop>(this, _$identity);
...
/// @nodoc
abstract mixin class $CreateShopCopyWith<$Res>
    implements $BecomeSellerEventCopyWith<$Res> {
  factory $CreateShopCopyWith(
          CreateShop value, $Res Function(CreateShop) _then) =
      _$CreateShopCopyWithImpl;
  @useResult
  $Res call({BuildContext context, CreateShopModel request});
}

/// @nodoc
class _$CreateShopCopyWithImpl<$Res> implements $CreateShopCopyWith<$Res> {
...
mixin _$BecomeSellerState {
  ...
  $BecomeSellerStateCopyWith<BecomeSellerState> get copyWith =>
      _$BecomeSellerStateCopyWithImpl<BecomeSellerState>(
          this as BecomeSellerState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is BecomeSellerState &&
...
abstract mixin class $BecomeSellerStateCopyWith<$Res> {
  factory $BecomeSellerStateCopyWith(
          BecomeSellerState value, $Res Function(BecomeSellerState) _then) =
      _$BecomeSellerStateCopyWithImpl;
  @useResult
  $Res call(
      {String? logoPath,
      String? bgPath,
...
class _BecomeSellerState implements BecomeSellerState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$BecomeSellerStateCopyWith<_BecomeSellerState> get copyWith =>
      __$BecomeSellerStateCopyWithImpl<_BecomeSellerState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _BecomeSellerState &&
            (identical(other.logoPath, logoPath) ||
                other.logoPath == logoPath) &&
            (identical(other.bgPath, bgPath) || other.bgPath == bgPath) &&
...
/// @nodoc
abstract mixin class _$BecomeSellerStateCopyWith<$Res>
    implements $BecomeSellerStateCopyWith<$Res> {
  factory _$BecomeSellerStateCopyWith(
          _BecomeSellerState value, $Res Function(_BecomeSellerState) _then) =
      __$BecomeSellerStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? logoPath,
