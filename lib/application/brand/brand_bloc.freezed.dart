...
mixin _$BrandEvent {
  ...
  $BrandEventCopyWith<BrandEvent> get copyWith =>
      _$BrandEventCopyWithImpl<BrandEvent>(this as BrandEvent, _$identity);
...
abstract mixin class $BrandEventCopyWith<$Res> {
  factory $BrandEventCopyWith(
          BrandEvent value, $Res Function(BrandEvent) _then) =
      _$BrandEventCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$BrandEventCopyWithImpl<$Res> implements $BrandEventCopyWith<$Res> {
...
class FetchBrands implements BrandEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FetchBrandsCopyWith<FetchBrands> get copyWith =>
      _$FetchBrandsCopyWithImpl<FetchBrands>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FetchBrands &&
            (identical(other.context, context) || other.context == context) &&
            (identical(other.isRefresh, isRefresh) ||
                other.isRefresh == isRefresh) &&
            (identical(other.shopId, shopId) || other.shopId == shopId) &&
...
/// @nodoc
abstract mixin class $FetchBrandsCopyWith<$Res>
    implements $BrandEventCopyWith<$Res> {
  factory $FetchBrandsCopyWith(
          FetchBrands value, $Res Function(FetchBrands) _then) =
      _$FetchBrandsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {BuildContext context,
...
/// @nodoc
class _$FetchBrandsCopyWithImpl<$Res> implements $FetchBrandsCopyWith<$Res> {
...
mixin _$BrandState {
  ...
  $BrandStateCopyWith<BrandState> get copyWith =>
      _$BrandStateCopyWithImpl<BrandState>(this as BrandState, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(brands), isLoading);
...
abstract mixin class $BrandStateCopyWith<$Res> {
  factory $BrandStateCopyWith(
          BrandState value, $Res Function(BrandState) _then) =
      _$BrandStateCopyWithImpl;
  @useResult
...
/// @nodoc
abstract mixin class _$BrandStateCopyWith<$Res>
    implements $BrandStateCopyWith<$Res> {
  factory _$BrandStateCopyWith(
          _BrandState value, $Res Function(_BrandState) _then) =
...
/// @nodoc
class __$BrandStateCopyWithImpl<$Res> implements _$BrandStateCopyWith<$Res> {
