...
mixin _$CompareEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is CompareEvent);
  }
...
class FetchCompare implements CompareEvent {
  const FetchCompare({required this.context, this.isRefresh, this.controller});
  ...
  $FetchCompareCopyWith<FetchCompare> get copyWith =>
      _$FetchCompareCopyWithImpl<FetchCompare>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FetchCompare &&
...
/// @nodoc
abstract mixin class $FetchCompareCopyWith<$Res>
    implements $CompareEventCopyWith<$Res> {
  factory $FetchCompareCopyWith(
          FetchCompare value, $Res Function(FetchCompare) _then) =
      _$FetchCompareCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$FetchCompareCopyWithImpl<$Res> implements $FetchCompareCopyWith<$Res> {
...
class SetExtraGroup implements CompareEvent {
  const SetExtraGroup({required final List<ProductData> products})
      : _products = products;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SetExtraGroupCopyWith<SetExtraGroup> get copyWith =>
      _$SetExtraGroupCopyWithImpl<SetExtraGroup>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SetExtraGroup &&
...
/// @nodoc
abstract mixin class $SetExtraGroupCopyWith<$Res>
    implements $CompareEventCopyWith<$Res> {
  factory $SetExtraGroupCopyWith(
          SetExtraGroup value, $Res Function(SetExtraGroup) _then) =
      _$SetExtraGroupCopyWithImpl;
  @useResult
...
mixin _$CompareState {
  ...
  $CompareStateCopyWith<CompareState> get copyWith =>
      _$CompareStateCopyWithImpl<CompareState>(
          this as CompareState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CompareState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            const DeepCollectionEquality().equals(other.compare, compare) &&
            const DeepCollectionEquality()
                .equals(other.extraGroup, extraGroup) &&
            const DeepCollectionEquality()
                .equals(other.propertyGroup, propertyGroup));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(extraGroup),
...
abstract mixin class $CompareStateCopyWith<$Res> {
  factory $CompareStateCopyWith(
          CompareState value, $Res Function(CompareState) _then) =
      _$CompareStateCopyWithImpl;
  @useResult
  $Res call(
      {bool isLoading,
...
class _CompareState implements CompareState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CompareStateCopyWith<_CompareState> get copyWith =>
      __$CompareStateCopyWithImpl<_CompareState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CompareState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
...
/// @nodoc
abstract mixin class _$CompareStateCopyWith<$Res>
    implements $CompareStateCopyWith<$Res> {
  factory _$CompareStateCopyWith(
          _CompareState value, $Res Function(_CompareState) _then) =
      __$CompareStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isLoading,
