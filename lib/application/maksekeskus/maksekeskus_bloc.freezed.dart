...
mixin _$MaksekeskusEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is MaksekeskusEvent);
  }
...
class $MaksekeskusEventCopyWith<$Res> {
  $MaksekeskusEventCopyWith(
      MaksekeskusEvent _, $Res Function(MaksekeskusEvent) __);
}
...
class SelectMethod implements MaksekeskusEvent {
  ...
  $SelectMethodCopyWith<SelectMethod> get copyWith =>
      _$SelectMethodCopyWithImpl<SelectMethod>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SelectMethod &&
...
/// @nodoc
abstract mixin class $SelectMethodCopyWith<$Res>
    implements $MaksekeskusEventCopyWith<$Res> {
  factory $SelectMethodCopyWith(
          SelectMethod value, $Res Function(SelectMethod) _then) =
      _$SelectMethodCopyWithImpl;
  @useResult
  $Res call({String link});
}

/// @nodoc
class _$SelectMethodCopyWithImpl<$Res> implements $SelectMethodCopyWith<$Res> {
...
class FetchMaksekeskus implements MaksekeskusEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FetchMaksekeskusCopyWith<FetchMaksekeskus> get copyWith =>
      _$FetchMaksekeskusCopyWithImpl<FetchMaksekeskus>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FetchMaksekeskus &&
...
/// @nodoc
abstract mixin class $FetchMaksekeskusCopyWith<$Res>
    implements $MaksekeskusEventCopyWith<$Res> {
  factory $FetchMaksekeskusCopyWith(
          FetchMaksekeskus value, $Res Function(FetchMaksekeskus) _then) =
      _$FetchMaksekeskusCopyWithImpl;
  @useResult
  $Res call(
...
mixin _$MaksekeskusState {
  ...
  $MaksekeskusStateCopyWith<MaksekeskusState> get copyWith =>
      _$MaksekeskusStateCopyWithImpl<MaksekeskusState>(
          this as MaksekeskusState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MaksekeskusState &&
...
abstract mixin class $MaksekeskusStateCopyWith<$Res> {
  factory $MaksekeskusStateCopyWith(
          MaksekeskusState value, $Res Function(MaksekeskusState) _then) =
      _$MaksekeskusStateCopyWithImpl;
  @useResult
  $Res call(
...
class _MaksekeskusState implements MaksekeskusState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MaksekeskusStateCopyWith<_MaksekeskusState> get copyWith =>
      __$MaksekeskusStateCopyWithImpl<_MaksekeskusState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _MaksekeskusState &&
            (identical(other.isLoading, isLoading) ||
                other.isLoading == isLoading) &&
            (identical(other.selectMethodLink, selectMethodLink) ||
                other.selectMethodLink == selectMethodLink) &&
...
/// @nodoc
abstract mixin class _$MaksekeskusStateCopyWith<$Res>
    implements $MaksekeskusStateCopyWith<$Res> {
  factory _$MaksekeskusStateCopyWith(
          _MaksekeskusState value, $Res Function(_MaksekeskusState) _then) =
      __$MaksekeskusStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isLoading, String? selectMethodLink, MaksekeskusData? maksekeskus});
