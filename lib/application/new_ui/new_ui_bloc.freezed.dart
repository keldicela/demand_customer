...
mixin _$NewUiEvent {
  ...
  $NewUiEventCopyWith<NewUiEvent> get copyWith =>
      _$NewUiEventCopyWithImpl<NewUiEvent>(this as NewUiEvent, _$identity);
...
abstract mixin class $NewUiEventCopyWith<$Res> {
  factory $NewUiEventCopyWith(
          NewUiEvent value, $Res Function(NewUiEvent) _then) =
      _$NewUiEventCopyWithImpl;
  @useResult
  $Res call({double top, double left});
}

/// @nodoc
class _$NewUiEventCopyWithImpl<$Res> implements $NewUiEventCopyWith<$Res> {
...
class UpdateCart implements NewUiEvent {
  ...
  $UpdateCartCopyWith<UpdateCart> get copyWith =>
      _$UpdateCartCopyWithImpl<UpdateCart>(this, _$identity);
...
/// @nodoc
abstract mixin class $UpdateCartCopyWith<$Res>
    implements $NewUiEventCopyWith<$Res> {
  factory $UpdateCartCopyWith(
          UpdateCart value, $Res Function(UpdateCart) _then) =
      _$UpdateCartCopyWithImpl;
  @override
  @useResult
  $Res call({double top, double left});
}
...
mixin _$NewUiState {
  ...
  $NewUiStateCopyWith<NewUiState> get copyWith =>
      _$NewUiStateCopyWithImpl<NewUiState>(this as NewUiState, _$identity);
...
abstract mixin class $NewUiStateCopyWith<$Res> {
  factory $NewUiStateCopyWith(
          NewUiState value, $Res Function(NewUiState) _then) =
      _$NewUiStateCopyWithImpl;
  @useResult
  $Res call({double top, double left});
}

/// @nodoc
class _$NewUiStateCopyWithImpl<$Res> implements $NewUiStateCopyWith<$Res> {
...
class _NewUiState implements NewUiState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$NewUiStateCopyWith<_NewUiState> get copyWith =>
      __$NewUiStateCopyWithImpl<_NewUiState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _NewUiState &&
            (identical(other.top, top) || other.top == top) &&
            (identical(other.left, left) || other.left == left));
  }
...
/// @nodoc
abstract mixin class _$NewUiStateCopyWith<$Res>
    implements $NewUiStateCopyWith<$Res> {
  factory _$NewUiStateCopyWith(
          _NewUiState value, $Res Function(_NewUiState) _then) =
      __$NewUiStateCopyWithImpl;
  @override
  @useResult
  $Res call({double top, double left});
}
...
/// @nodoc
class __$NewUiStateCopyWithImpl<$Res> implements _$NewUiStateCopyWith<$Res> {
