...
mixin _$ParcelsListEvent {
  ...
  $ParcelsListEventCopyWith<ParcelsListEvent> get copyWith =>
      _$ParcelsListEventCopyWithImpl<ParcelsListEvent>(
          this as ParcelsListEvent, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParcelsListEvent &&
...
abstract mixin class $ParcelsListEventCopyWith<$Res> {
  factory $ParcelsListEventCopyWith(
          ParcelsListEvent value, $Res Function(ParcelsListEvent) _then) =
      _$ParcelsListEventCopyWithImpl;
  @useResult
  $Res call(
...
class FetchActiveParcel implements ParcelsListEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FetchActiveParcelCopyWith<FetchActiveParcel> get copyWith =>
      _$FetchActiveParcelCopyWithImpl<FetchActiveParcel>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FetchActiveParcel &&
            (identical(other.context, context) || other.context == context) &&
            (identical(other.isRefresh, isRefresh) ||
                other.isRefresh == isRefresh) &&
            (identical(other.controller, controller) ||
...
/// @nodoc
abstract mixin class $FetchActiveParcelCopyWith<$Res>
    implements $ParcelsListEventCopyWith<$Res> {
  factory $FetchActiveParcelCopyWith(
          FetchActiveParcel value, $Res Function(FetchActiveParcel) _then) =
      _$FetchActiveParcelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {BuildContext context, bool? isRefresh, RefreshController? controller});
...
class FetchHistoryParcel implements ParcelsListEvent {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $FetchHistoryParcelCopyWith<FetchHistoryParcel> get copyWith =>
      _$FetchHistoryParcelCopyWithImpl<FetchHistoryParcel>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is FetchHistoryParcel &&
            (identical(other.context, context) || other.context == context) &&
            (identical(other.isRefresh, isRefresh) ||
                other.isRefresh == isRefresh) &&
            (identical(other.controller, controller) ||
...
/// @nodoc
abstract mixin class $FetchHistoryParcelCopyWith<$Res>
    implements $ParcelsListEventCopyWith<$Res> {
  factory $FetchHistoryParcelCopyWith(
          FetchHistoryParcel value, $Res Function(FetchHistoryParcel) _then) =
      _$FetchHistoryParcelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {BuildContext context, bool? isRefresh, RefreshController? controller});
...
mixin _$ParcelsListState {
  ...
  $ParcelsListStateCopyWith<ParcelsListState> get copyWith =>
      _$ParcelsListStateCopyWithImpl<ParcelsListState>(
          this as ParcelsListState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParcelsListState &&
            ...
            const DeepCollectionEquality()
                .equals(other.historyOrders, historyOrders));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(historyOrders));
...
abstract mixin class $ParcelsListStateCopyWith<$Res> {
  factory $ParcelsListStateCopyWith(
          ParcelsListState value, $Res Function(ParcelsListState) _then) =
      _$ParcelsListStateCopyWithImpl;
  @useResult
  $Res call(
...
class _ParcelsListState implements ParcelsListState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParcelsListStateCopyWith<_ParcelsListState> get copyWith =>
      __$ParcelsListStateCopyWithImpl<_ParcelsListState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParcelsListState &&
            (identical(other.isActiveLoading, isActiveLoading) ||
                other.isActiveLoading == isActiveLoading) &&
            (identical(other.isHistoryLoading, isHistoryLoading) ||
                other.isHistoryLoading == isHistoryLoading) &&
...
/// @nodoc
abstract mixin class _$ParcelsListStateCopyWith<$Res>
    implements $ParcelsListStateCopyWith<$Res> {
  factory _$ParcelsListStateCopyWith(
          _ParcelsListState value, $Res Function(_ParcelsListState) _then) =
      __$ParcelsListStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool isActiveLoading,
