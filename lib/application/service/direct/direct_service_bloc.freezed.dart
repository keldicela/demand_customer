...
mixin _$DirectServiceEvent {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is DirectServiceEvent);
  }
...
class $DirectServiceEventCopyWith<$Res> {
  $DirectServiceEventCopyWith(
      DirectServiceEvent _, $Res Function(DirectServiceEvent) __);
}
...
/// @nodoc
abstract mixin class $InitCopyWith<$Res>
    implements $DirectServiceEventCopyWith<$Res> {
  factory $InitCopyWith(Init value, $Res Function(Init) _then) =
      _$InitCopyWithImpl;
  @useResult
  $Res call({BuildContext context, int? serviceId});
}

/// @nodoc
class _$InitCopyWithImpl<$Res> implements $InitCopyWith<$Res> {
...
mixin _$DirectServiceState {
  List<ServiceExtra> get selectedExtras;
  bool get isLoading;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $DirectServiceStateCopyWith<DirectServiceState> get copyWith =>
      _$DirectServiceStateCopyWithImpl<DirectServiceState>(
          this as DirectServiceState, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DirectServiceState &&
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(selectedExtras), isLoading, service);
...
abstract mixin class $DirectServiceStateCopyWith<$Res> {
  factory $DirectServiceStateCopyWith(
          DirectServiceState value, $Res Function(DirectServiceState) _then) =
      _$DirectServiceStateCopyWithImpl;
  @useResult
  $Res call(
...
class _DirectServiceState implements DirectServiceState {
  const _DirectServiceState(
      {final List<ServiceExtra> selectedExtras = const [],
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$DirectServiceStateCopyWith<_DirectServiceState> get copyWith =>
      __$DirectServiceStateCopyWithImpl<_DirectServiceState>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _DirectServiceState &&
            const DeepCollectionEquality()
  ...
  @override
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_selectedExtras), isLoading, service);
...
/// @nodoc
abstract mixin class _$DirectServiceStateCopyWith<$Res>
    implements $DirectServiceStateCopyWith<$Res> {
  factory _$DirectServiceStateCopyWith(
          _DirectServiceState value, $Res Function(_DirectServiceState) _then) =
      __$DirectServiceStateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {List<ServiceExtra> selectedExtras,
