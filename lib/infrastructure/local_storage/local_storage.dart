...
abstract class LocalStorage {
  ...
  static Future<bool>? deleteSettingsList() => local?.remove(StorageKeys.keyGlobalSettings);
  ...
  static Future<bool>? deleteTranslations() => local?.remove(StorageKeys.keyTranslations);
  ...
  static Future<bool>? deleteLanguage() => local?.remove(StorageKeys.keyLangSelected);
  ...
  static Future<bool>? deleteWareHouse() => local?.remove(StorageKeys.keyWareHouse);
