...
import '../../../application/become_seller/become_seller_bloc.dart';
...
import 'widgets/bg_image_screen.dart';
...
class _BecomeSellerPageState extends State<BecomeSellerPage> {
  ...
  void createShop(BecomeSellerState state) {
                          ...
                          : Form(
                              ...
                              child: Expanded(
                                child: ListView(
                                  ...
                                  shrinkWrap: true,
                                  children: [
                                    if(LocalStorage.getUser().shop?.statusNote != null &&
                                       LocalStorage.getUser().shop!.statusNote!.isNotEmpty)
                                      Padding(
                                        padding: EdgeInsets.only(bottom: 16.r),
                                        child: Text(
                                          LocalStorage.getUser().shop!.statusNote!,
