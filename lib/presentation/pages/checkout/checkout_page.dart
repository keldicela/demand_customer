...
class _CheckoutPageState extends State<CheckoutPage>
  ...
  void createOrder(CheckoutState state, CartState cartState) {
    int? deliveryPriceId;
    try {
    ...
    context.read<OrderBloc>().add(
          OrderEvent.createOrder(
              ...
              order: CreateOrderModel(
                paymentId: (state.payments.firstWhere(
              ...
              payment: state.payments.firstWhere(
                  (element) => element.id == state.selectedPayment?.id,
                  orElse: () {
                return PaymentData();
              })),
            ...
            children: [
              ...
              if (state.step == 4)
                PaymentMethodsScreen(
                  colors: colors,
                  payments: state.availablePayments,
                  selectedPayment: state.selectedPayment!,
                  select: (PaymentData payment) {
                    context
                        .read<CheckoutBloc>()
                        .add(CheckoutEvent.changePayment(payment: payment));
                  },
                ),
            ],
          );
        ...
        child: BlocBuilder<CheckoutBloc, CheckoutState>(
          buildWhen: (p, n) {
            return p.step != n.step ||
                ...
                p.selectedPayment != n.selectedPayment ||
