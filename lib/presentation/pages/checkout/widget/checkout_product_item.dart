          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (!(cartItem?.bonus ?? false))
                  Text(
                    "${AppHelpers.numberFormat(cartItem?.stocks?.totalPrice)} X ${(cartItem?.quantity ?? 0) * (cartItem?.stocks?.product?.interval ?? 1)}",
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (!(cartItem?.bonus ?? false))
                          Text(
                            "${AppHelpers.numberFormat(cartItem?.replaceStock?.totalPrice)} X ${(cartItem?.replaceQuantity ?? 0) * (cartItem?.replaceStock?.product?.interval ?? 1)}",
                            style: CustomStyle.interBold(
                                color: colors.textBlack, size: 14),
                          ),
                        if (cartItem?.bonus ?? false)
