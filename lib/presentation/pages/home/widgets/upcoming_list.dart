                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "${TimeService.timeFormat(state.upcoming[index].startDate)} - ${TimeService.timeFormat(state.upcoming[index].endDate)} - ${AppHelpers.numberFormat(state.upcoming[index].totalPriceByParent)}",
                          style: CustomStyle.interNormal(
