                                  ...
                                  BlocBuilder<CheckoutBloc, CheckoutState>(
                                    ...
                                    builder: (context, stateCheckout) {
                                      return PaymentMethodsScreen(
                                        parcel: true,
                                        colors: colors,
                                        payments: stateCheckout.payments,
                                        selectedPayment:
                                            stateCheckout.selectedPayment!,
                            ...
                            builder: (context, stateCheckout) {
                              return CustomButton(
                                ...
                                titleColor: !state.error
                                    ...
                                    : colors.textWhite,
                                title:
                                    "${state.expand ? AppHelpers.getTranslation(TrKeys.order) : AppHelpers.getTranslation(TrKeys.continueText)} ${AppHelpers.numberFormat(state.calculate?.data?.price ?? 0)}",
                                onTap: () {
                                  if (state.error) {
                                    return;
                                  }
