...
abstract class AppRoute {
  ...
  static Future goMain(BuildContext context) =>
  ...
  static void goUpdatePasswordBottomSheet(BuildContext context,
  ...
  static Future goSearchPage({required BuildContext context, int? shopId}) {
  ...
  static Future goComparePage({required BuildContext context}) {
    return Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => MultiBlocProvider(
          providers: [
  ...
  static Future goOrdersList({required BuildContext context}) {
    return Navigator.of(context).push(
      MaterialPageRoute(
          builder: (_) => MultiBlocProvider(
                providers: [
  ...
  static Future goMyDigitalList({required BuildContext context}) {
    return Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => MultiBlocProvider(
          providers: [
