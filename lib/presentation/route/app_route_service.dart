...
abstract class AppRouteService {
  ...
  static Future goSelectMaster({required BuildContext context, required int? shopId}) {
  ...
  static Future goAddNotePage({required BuildContext context, required int shopId}) {
    return Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => MultiBlocProvider(
          providers: [
