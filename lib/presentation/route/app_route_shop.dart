...
abstract class AppRouteShop {
            ...
            providers: [
              ...
              BlocProvider(
                create: (context) => ServiceBloc()
                  ..add(ServiceEvent.fetchServiceCategories(
  ...
  static void goGalleryListPage(
    ...
    Navigator.of(context).push(GalleryListPage.route(
      context,
      list: list,
    ));
  }
  ...
  static Future goBecomeSeller({required BuildContext context}) {
    ...
    return AppHelpers.showCustomModalBottomSheetDrag(
      ...
      modal: (c) => BlocProvider.value(
        value: context.read<GiftCartBloc>()
          ..add(
            GiftCartEvent.fetchPayments(context: context, currentGift: model),
          ),
